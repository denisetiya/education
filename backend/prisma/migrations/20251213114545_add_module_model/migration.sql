...
INSERT INTO "new_Material" ("category", "content", "createdAt", "createdById", "grade", "id", "level", "linkedQuizId", "minPassingScore", "order", "semester", "title", "type", "updatedAt") SELECT "category", "content", "createdAt", "createdById", "grade", "id", "level", "linkedQuizId", "minPassingScore", "order", "semester", "title", "type", "updatedAt" FROM "Material";
DROP TABLE "Material";
